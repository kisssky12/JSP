...
<body>
	<h3>회원관리</h3>
	<div class="row">
		<div class="col"><div id="memlist"></div></div>
		<div class="col"><form id="frm" name="frm" action="memberInsert.do" method="post" enctype="multipart/form-data">
			<table border="1">
				<tr>
					<th width="150">아이디</th>
				...
				<tr>
					<td colspan="2" align="center"><input type="button" id="btnSave" value="가입하기"> &nbsp;&nbsp; 
