...
public class MemberDAO extends DAO {
	...
	public List<MemberVO> selectAll() { // Memberlist 전체를 가져오는 메소드
		List<MemberVO> list = new ArrayList<MemberVO>(); // ArrayList로 선택(추상클래스 List)
		try {
	...
	public MemberVO select(MemberVO vo) { // select 한 행을 찾을 때
		try {
	...
	public int insert(MemberVO vo) { // insert
		...
		try {
			...
			n = psmt.executeUpdate(); // select(insert)는 무조건 executeUpdate();
